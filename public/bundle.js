...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = _react2.default.createClass({
	  ...
	  init: function init() {
	    _Helpers2.default.getInfo().then((function (dataObj) {
	      this.setState({
	  ...
	  valueChange: function valueChange(data, title) {
	    _Helpers2.default.valueChange(data, title);
	  },

	  submitForm: function submitForm() {
	    _Helpers2.default.postInfo().then((function (dataObj) {
	      this.setState({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_Row2.default, { emails: this.state.emails, names: this.state.names, titles: this.state.titles, desc: this.state.desc, submit: this.submitForm, valueChanger: this.valueChange })
	    );
	  }
	});
	...
	var Row = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var columns = this.props.titles.map((function (t, index) {
	      return _react2.default.createElement(_Column2.default, { title: t, description: description[index], emails: emails, names: names, key: index, valueChange: this.props.valueChanger });
	    }).bind(this));
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { className: 'waves-effect waves-light blue darken-1 btn-large center', onClick: this.handleSubmit },
	          'Submit'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSelectize = __webpack_require__(166);
	...
	var Column = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col s12 m6 l4 column' },
	        _react2.default.createElement(
	          'div',
	          { className: 'center' },
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  HighlightedText = __webpack_require__(167);
	  SimpleSelect = __webpack_require__(174);
	  MultiSelect = __webpack_require__(184);
	  ReactSelectize = __webpack_require__(176);
	  module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  map = __webpack_require__(168).map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Func = __webpack_require__(169);
	List = __webpack_require__(170);
	Obj = __webpack_require__(171);
	Str = __webpack_require__(172);
	Num = __webpack_require__(173);
	id = function(x){
	  return x;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  ref$ = __webpack_require__(168), all = ref$.all, any = ref$.any, drop = ref$.drop, camelize = ref$.camelize, difference = ref$.difference, filter = ref$.filter, find = ref$.find, findIndex = ref$.findIndex, last = ref$.last, map = ref$.map, reject = ref$.reject;
	  isEqualToObject = __webpack_require__(175).isEqualToObject;
	  React = __webpack_require__(1), createFactory = React.createFactory, ref$ = React.DOM, div = ref$.div, img = ref$.img, span = ref$.span;
	  ReactSelectize = createFactory(__webpack_require__(176));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  ref$ = __webpack_require__(168), all = ref$.all, any = ref$.any, each = ref$.each, filter = ref$.filter, find = ref$.find, isType = ref$.isType, keys = ref$.keys, map = ref$.map, Obj = ref$.Obj, partition = ref$.partition, reverse = ref$.reverse, sortBy = ref$.sortBy;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  ref$ = __webpack_require__(168), each = ref$.each, filter = ref$.filter, find = ref$.find, findIndex = ref$.findIndex, id = ref$.id, initial = ref$.initial, last = ref$.last, map = ref$.map, objToPairs = ref$.objToPairs, partition = ref$.partition, reject = ref$.reject, reverse = ref$.reverse, sortBy = ref$.sortBy, sum = ref$.sum, values = ref$.values;
	  ref$ = __webpack_require__(175), clamp = ref$.clamp, isEqualToObject = ref$.isEqualToObject;
	  ...
	  ReactCSSTransitionGroup = createFactory(__webpack_require__(177));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  ...
	  ref$ = __webpack_require__(168), all = ref$.all, any = ref$.any, camelize = ref$.camelize, difference = ref$.difference, drop = ref$.drop, filter = ref$.filter, find = ref$.find, findIndex = ref$.findIndex, last = ref$.last, map = ref$.map, reject = ref$.reject;
	  isEqualToObject = __webpack_require__(175).isEqualToObject;
	  React = __webpack_require__(1), createFactory = React.createFactory, ref$ = React.DOM, div = ref$.div, img = ref$.img, span = ref$.span;
	  ReactSelectize = createFactory(__webpack_require__(176));
	  module.exports = React.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./row.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./row.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".each-row {\n  margin: 30px 50px 30px 50px;\n}\n.button-container {\n  text-align: center;\n  margin-bottom: 50px;\n}\n.hidden {\n  display: none;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	  getInfo: function getInfo() {
	    return axios.all([getUserInfo()]).then(function (arr) {
	      return {
	  ...
	  postInfo: function postInfo() {
	    return axios.all([postUserInfo(datas)]).then(function (arr) {
	      //datas = {}
	      return {
	  ...
	  valueChange: function valueChange(val, title) {
	    datas[title] = val;
